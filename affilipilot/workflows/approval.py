...
def create_approval_batch(input_path: str | Path, out_dir: str | Path, db_path: str | Path, *, batch_key: str, limit: int = 5) -> dict:
    manifest = build_batch(input_path, out_dir, limit=limit)
